import { ACMCertificateApproachingExpiration } from '../ACMCertificateApproachingExpiration';
...
let typeMap: {[index: string]: any} = {
    "ACMCertificateApproachingExpiration": ACMCertificateApproachingExpiration,
    "AWSEvent": AWSEvent,
}
