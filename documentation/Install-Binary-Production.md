Use the following as reference if and when creating ABIs that need to have a client-related installation candidate:

(Mongo's Atlas Installation Script - Python):
