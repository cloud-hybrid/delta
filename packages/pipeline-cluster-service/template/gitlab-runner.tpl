...
if [[ $(echo ${runners_executor}) == "docker" ]]; then
...
if [[ $(echo ${runners_install_amazon_ecr_credential_helper}) == "true" ]]; then
...
if [[ $(echo ${docker_machine_download_url}) == "" ]]; then
...
if [[ $(echo ${runners_token}) == "__REPLACED_BY_USER_DATA__" && $(echo $token) == "null" ]] || [[ $(echo $valid_token) == "false" ]]; then
...
if [[ $(echo ${sentry_dsn}) == "__SENTRY_DSN_REPLACED_BY_USER_DATA__" && $(echo $ssm_sentry_dsn) == "null" ]]; then
    ssm_sentry_dsn=""
fi
