...
const schema22 = {
    ...
    "properties": {
        "ID": { "type": "string" },
        "Comment": { "$comment": "An inline comment describing the provider's document." },
        "Title": {
        ...
        "References": { "$comment": "Related or reference VCS-based source(s).", "$ref": "#/definitions/Array.urls" },
        "Definitions": {
            "type": "object",
        ...
        "Type": {
            ...
            "examples": [ "Organization-Environment-Service-Resource" ],
            "type": "string",
            "pattern": "^([a-zA-Z0-9-]){2,64}-[a-zA-Z0-9]{2,64}-[a-zA-Z0-9]{2,64}-[a-zA-Z0-9]{2,64}$"
        },
        "Types": { "enum": [ "array", "boolean", "integer", "null", "number", "object", "string" ] },
        "Resources": {
            "type": "object",
            "patternProperties": { "^[A-Za-z0-9]{1,64}$": { "$ref": "#/definitions/properties" } },
            "additionalProperties": false,
    ...
    "definitions": {
        ...
        "Negative": { "type": "integer", "maximum": 0 },
        "Types": { "enum": [ "array", "boolean", "integer", "null", "number", "object", "string" ] },
        "URL": {
            "type": "string",
        ...
        "Schemas": { "type": "array", "minItems": 1, "items": { "$ref": "#" } },
        "Array": { "type": "array" },
        "Array.unique": { "type": "array", "uniqueItems": true, "minItems": 1, "items": { "type": "string" } },
        "Array.pointers": { "type": "array", "minItems": 1, "items": { "type": "string" } },
        "Array.urls": { "type": "array", "minItems": 1, "items": { "$ref": "#/definitions/URL" } },
        "Array.schemas": { "type": "array", "minItems": 1, "items": { "$ref": "#/definitions/properties" } },
        "properties": {
            "allOf": [ {
                ...
                "type": "object",
                "properties": {
                    "$ref": { "$ref": "http://json-schema.org/draft-07/schema#" },
                    ...
                    "pattern": { "$ref": "http://json-schema.org/draft-07/schema#" },
                    "items": {
                    ...
                    "allOf": { "$ref": "#/definitions/Array.schemas" },
                    "anyOf": { "$ref": "#/definitions/Array.schemas" },
                    "oneOf": { "$ref": "#/definitions/Array.schemas" }
                },
                "additionalProperties": false
            } ], "default": true
        }
...
const schema24 = { "type": "string" };
const schema25 = {
    "type": "string",
    "pattern": "^https://[0-9a-zA-Z]([-.\\w]*[0-9a-zA-Z])(:[0-9]*)*([?/#].*)?$",
    "maxLength": 4096
};
const schema59 = { "type": "array", "minItems": 1, "items": { "type": "string" } };
const func8 = Object.prototype.hasOwnProperty;
const func9 = require("ajv/dist/runtime/ucs2length").default;
const func0 = require("ajv/dist/runtime/equal").default;
const pattern0 = new RegExp("^https://[0-9a-zA-Z]([-.\\w]*[0-9a-zA-Z])(:[0-9]*)*([?/#].*)?$", "u");
const pattern2 = new RegExp("^[A-Za-z0-9]{1,64}$", "u");
const pattern7 = new RegExp("^([a-zA-Z0-9-]){2,64}-[a-zA-Z0-9]{2,64}-[a-zA-Z0-9]{2,64}-[a-zA-Z0-9]{2,64}$", "u");
const schema26 = { "type": "array", "minItems": 1, "items": { "$ref": "#/definitions/URL" } };
                        ...
                        if ( typeof data0 === "string" ) {
                            if ( func9(data0) > 4096 ) {
                                validate21.errors = [ {
                                    ...
                                    schemaPath: "#/definitions/URL/maxLength",
                                    keyword: "maxLength",
                                    params: { limit: 4096 },
                                ...
                                if ( !pattern0.test(data0) ) {
                                    validate21.errors = [ {
                                        ...
                                        keyword: "pattern",
                                        params: { pattern: "^https://[0-9a-zA-Z]([-.\\w]*[0-9a-zA-Z])(:[0-9]*)*([?/#].*)?$" },
                                        message: "must match pattern \"" + "^https://[0-9a-zA-Z]([-.\\w]*[0-9a-zA-Z])(:[0-9]*)*([?/#].*)?$" + "\""
                                    } ];
                                    return false;
                                }
                            }
...
const schema29 = { "type": "string" };
const schema32 = { "type": "array", "items": true };
const schema33 = true;
const schema34 = { "type": "number", "exclusiveMinimum": 0 };
const schema35 = { "type": "number" };
const schema36 = { "type": "number" };
const schema37 = { "type": "number" };
const schema38 = { "type": "number" };
const schema12 = { "type": "integer", "minimum": 0 };
const schema45 = { "type": "boolean", "default": false };
const schema18 = { "type": "array", "items": { "type": "string" }, "uniqueItems": true, "default": [] };
const schema52 = { "type": "array", "items": true, "minItems": 1, "uniqueItems": true };
...
function validate10(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {/*# sourceURL="http://json-schema.org/draft-07/schema#" */
    ;let vErrors = null;
    let errors = 0;
                                                                            ...
                                                                            if ( valid0 ) {
                                                                                if ( data.items !== undefined ) {
                                                                                    ...
                                                                                    if ( !valid2 ) {
                                                                                        ...
                                                                                        errors = _errs35;
                                                                                        if ( vErrors !== null ) {if ( _errs35 ) {vErrors.length = _errs35;} else {vErrors = null;}}
                                                                                    }
                                                                                                                                        ...
                                                                                                                                        if ( data33 && typeof data33 == "object" && !Array.isArray(data33) ) {
                                                                                                                                            for ( const key4 in data33 ) {
                                                                                                                                                ...
                                                                                                                                                if ( !valid13 ) {
                                                                                                                                                    ...
                                                                                                                                                    errors = _errs72;
                                                                                                                                                    if ( vErrors !== null ) {if ( _errs72 ) {vErrors.length = _errs72;} else {vErrors = null;}}
                                                                                                                                                }
                                                                                                                                        ...
                                                                                                                                        if ( valid0 ) {
                                                                                                                                            if ( data.type !== undefined ) {
                                                                                                                                                ...
                                                                                                                                                if ( !valid18 ) {
                                                                                                                                                    ...
                                                                                                                                                    errors = _errs83;
                                                                                                                                                    if ( vErrors !== null ) {if ( _errs83 ) {vErrors.length = _errs83;} else {vErrors = null;}}
                                                                                                                                                }
...
function validate34(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
                            ...
                            outer0:for ( ; i1--; ) {
                                for ( j0 = i1; j0--; ) {
                                    if ( func0(data[ i1 ], data[ j0 ]) ) {
                                        const err3 = {
                                            instancePath,
                                            schemaPath: "#/anyOf/1/uniqueItems",
                                            keyword: "uniqueItems",
                                            params: { i: i1, j: j0 },
                                            message: "must NOT have duplicate items (items ## " + j0 + " and " + i1 + " are identical)"
                                        };
    ...
    if ( !valid0 ) {
        ...
        errors = _errs0;
        if ( vErrors !== null ) {if ( _errs0 ) {vErrors.length = _errs0;} else {vErrors = null;}}
    }
    validate34.errors = vErrors;
    return errors === 0;
}

const schema57 = { "type": "array", "minItems": 1, "items": { "$ref": "#/definitions/properties" } };
    ...
    if ( errors === _errs0 ) {
        if ( data && typeof data == "object" && !Array.isArray(data) ) {
            ...
            for ( const key0 in data ) {
                if ( !( func8.call(schema28.allOf[ 0 ].properties, key0) ) ) {
                    validate23.errors = [ {
                        instancePath,
                ...
                if ( valid1 ) {
                    if ( data.$comment !== undefined ) {
                        ...
                        if ( typeof data.$comment !== "string" ) {
                            validate23.errors = [ {
                                instancePath: instancePath + "/$comment",
                                schemaPath: "http://json-schema.org/draft-07/schema#/properties/$comment/type",
                                keyword: "type",
                                params: { type: "string" },
                                message: "must be string"
                            } ];
                    ...
                    if ( valid1 ) {
                        if ( data.title !== undefined ) {
                            ...
                            if ( typeof data.title !== "string" ) {
                                validate23.errors = [ {
                                    instancePath: instancePath + "/title",
                                    schemaPath: "http://json-schema.org/draft-07/schema#/properties/title/type",
                                    keyword: "type",
                                    params: { type: "string" },
                                    message: "must be string"
                                } ];
                        ...
                        if ( valid1 ) {
                            if ( data.description !== undefined ) {
                                ...
                                if ( typeof data.description !== "string" ) {
                                    validate23.errors = [ {
                                        instancePath: instancePath + "/description",
                                        schemaPath: "http://json-schema.org/draft-07/schema#/properties/description/type",
                                        keyword: "type",
                                        params: { type: "string" },
                                        message: "must be string"
                                    } ];
                            ...
                            if ( valid1 ) {
                                if ( data.examples !== undefined ) {
                                    ...
                                    if ( errors === _errs15 ) {
                                        if ( !( Array.isArray(data.examples) ) ) {
                                            validate23.errors = [ {
                                                instancePath: instancePath + "/examples",
                                                schemaPath: "http://json-schema.org/draft-07/schema#/properties/examples/type",
                                                keyword: "type",
                                                params: { type: "array" },
                                                message: "must be array"
                                            } ];
                                ...
                                if ( valid1 ) {
                                    ...
                                    if ( valid1 ) {
                                            ...
                                            if ( errors === _errs19 ) {
                                                if ( ( typeof data6 == "number" ) && ( isFinite(data6) ) ) {
                                                    if ( data6 <= 0 || isNaN(data6) ) {
                                                        validate23.errors = [ {
                                                            instancePath: instancePath + "/multipleOf",
                                                            schemaPath: "http://json-schema.org/draft-07/schema#/properties/multipleOf/exclusiveMinimum",
                                                            keyword: "exclusiveMinimum",
                                                            params: { comparison: ">", limit: 0 },
                                                            message: "must be > 0"
                                                        } ];
                                                    ...
                                                    validate23.errors = [ {
                                                        instancePath: instancePath + "/multipleOf",
                                                        schemaPath: "http://json-schema.org/draft-07/schema#/properties/multipleOf/type",
                                                        keyword: "type",
                                                        params: { type: "number" },
                                                        message: "must be number"
                                                    } ];
                                        ...
                                        if ( valid1 ) {
                                            if ( data.maximum !== undefined ) {
                                                let data7 = data.maximum;
                                                const _errs21 = errors;
                                                if ( !( ( typeof data7 == "number" ) && ( isFinite(data7) ) ) ) {
                                                    validate23.errors = [ {
                                                        instancePath: instancePath + "/maximum",
                                                        schemaPath: "http://json-schema.org/draft-07/schema#/properties/maximum/type",
                                                        keyword: "type",
                                                        params: { type: "number" },
                                                        message: "must be number"
                                                    } ];
                                                ...
                                                if ( valid1 ) {
                                                    if ( data.minimum !== undefined ) {
                                                        ...
                                                        if ( !( ( typeof data9 == "number" ) && ( isFinite(data9) ) ) ) {
                                                            validate23.errors = [ {
                                                                instancePath: instancePath + "/minimum",
                                                                schemaPath: "http://json-schema.org/draft-07/schema#/properties/minimum/type",
                                                                keyword: "type",
                                                                params: { type: "number" },
                                                                message: "must be number"
                                                            } ];
                                                    ...
                                                    if ( valid1 ) {
                                                        if ( data.exclusiveMinimum !== undefined ) {
                                                            let data10 = data.exclusiveMinimum;
                                                            const _errs30 = errors;
                                                            if ( !( ( typeof data10 == "number" ) && ( isFinite(data10) ) ) ) {
                                                                validate23.errors = [ {
                                                                    instancePath: instancePath + "/exclusiveMinimum",
                                                        ...
                                                        if ( valid1 ) {
                                                            if ( data.maxLength !== undefined ) {
                                                                let data11 = data.maxLength;
                                                                const _errs33 = errors;
                                                                const _errs34 = errors;
                                                                if ( !( ( ( typeof data11 == "number" ) && ( !( data11 % 1 ) && !isNaN(data11) ) ) && ( isFinite(data11) ) ) ) {
                                                                    validate23.errors = [ {
                                                                        instancePath: instancePath + "/maxLength",
                                                                        schemaPath: "http://json-schema.org/draft-07/schema#/properties/maxLength/type",
                                                                        keyword: "type",
                                                                        params: { type: "integer" },
                                                                        message: "must be integer"
                                                                    } ];
                                                                ...
                                                                if ( errors === _errs34 ) {
                                                                    if ( ( typeof data11 == "number" ) && ( isFinite(data11) ) ) {
                                                                        if ( data11 < 0 || isNaN(data11) ) {
                                                                            validate23.errors = [ {
                                                                                instancePath: instancePath + "/maxLength",
                                                                                schemaPath: "http://json-schema.org/draft-07/schema#/properties/maxLength/minimum",
                                                                                keyword: "minimum",
                                                                                params: { comparison: ">=", limit: 0 },
                                                                                message: "must be >= 0"
                                                                            } ];
                                                            ...
                                                            if ( valid1 ) {
                                                                ...
                                                                if ( valid1 ) {
                                                                    ...
                                                                    if ( valid1 ) {
                                                                        if ( data.items !== undefined ) {
                                                                            const _errs38 = errors;
                                                                            if ( !( wrapper0.validate(data.items, {
                                                                                instancePath: instancePath + "/items",
                                                                                parentData: data,
                                                                                parentDataProperty: "items",
                                                                                rootData
                                                                        ...
                                                                        if ( valid1 ) {
                                                                            if ( data.maxItems !== undefined ) {
                                                                                let data15 = data.maxItems;
                                                                                const _errs40 = errors;
                                                                                const _errs41 = errors;
                                                                                if ( !( ( ( typeof data15 == "number" ) && ( !( data15 % 1 ) && !isNaN(data15) ) ) && ( isFinite(data15) ) ) ) {
                                                                                    validate23.errors = [ {
                                                                                        instancePath: instancePath + "/maxItems",
                                                                                        schemaPath: "http://json-schema.org/draft-07/schema#/properties/maxItems/type",
                                                                                        keyword: "type",
                                                                                        params: { type: "integer" },
                                                                                        message: "must be integer"
                                                                                    } ];
                                                                                ...
                                                                                if ( errors === _errs41 ) {
                                                                                    if ( ( typeof data15 == "number" ) && ( isFinite(data15) ) ) {
                                                                                        if ( data15 < 0 || isNaN(data15) ) {
                                                                                            validate23.errors = [ {
                                                                                                instancePath: instancePath + "/maxItems",
                                                                                                schemaPath: "http://json-schema.org/draft-07/schema#/properties/maxItems/minimum",
                                                                                                keyword: "minimum",
                                                                                                params: {
                                                                                                    comparison: ">=",
                                                                                                    limit: 0
                                                                                ...
                                                                                if ( valid1 ) {
                                                                                    if ( data.uniqueItems !== undefined ) {
                                                                                        ...
                                                                                        if ( typeof data.uniqueItems !== "boolean" ) {
                                                                                            validate23.errors = [ {
                                                                                                instancePath: instancePath + "/uniqueItems",
                                                                                                schemaPath: "http://json-schema.org/draft-07/schema#/properties/uniqueItems/type",
                                                                                                keyword: "type",
                                                                                                params: { type: "boolean" },
                                                                                                message: "must be boolean"
                                                                                            } ];
                                                                                    ...
                                                                                    if ( valid1 ) {
                                                                                        ...
                                                                                        if ( valid1 ) {
                                                                                            if ( data.maxProperties !== undefined ) {
                                                                                                let data19 = data.maxProperties;
                                                                                                const _errs48 = errors;
                                                                                                const _errs49 = errors;
                                                                                                if ( !( ( ( typeof data19 == "number" ) && ( !( data19 % 1 ) && !isNaN(data19) ) ) && ( isFinite(data19) ) ) ) {
                                                                                                    validate23.errors = [ {
                                                                                                        instancePath: instancePath + "/maxProperties",
                                                                                                        schemaPath: "http://json-schema.org/draft-07/schema#/properties/maxProperties/type",
                                                                                                        keyword: "type",
                                                                                                        params: { type: "integer" },
                                                                                                        message: "must be integer"
                                                                                                    } ];
                                                                                                ...
                                                                                                if ( errors === _errs49 ) {
                                                                                                    if ( ( typeof data19 == "number" ) && ( isFinite(data19) ) ) {
                                                                                                        if ( data19 < 0 || isNaN(data19) ) {
                                                                                                            validate23.errors = [ {
                                                                                                                instancePath: instancePath + "/maxProperties",
                                                                                                                schemaPath: "http://json-schema.org/draft-07/schema#/properties/maxProperties/minimum",
                                                                                                                keyword: "minimum",
                                                                                                                params: {
                                                                                                                    comparison: ">=",
                                                                                                                    limit: 0
                                                                                            ...
                                                                                            if ( valid1 ) {
                                                                                                if ( data.minProperties !== undefined ) {
                                                                                                    ...
                                                                                                    if ( !( validate32(data.minProperties, {
                                                                                                        instancePath: instancePath + "/minProperties",
                                                                                                        parentData: data,
                                                                                                        parentDataProperty: "minProperties",
                                                                                                        rootData
                                                                                                ...
                                                                                                if ( valid1 ) {
                                                                                                            ...
                                                                                                            if ( Array.isArray(data21) ) {
                                                                                                                ...
                                                                                                                for ( let i0 = 0; i0 < len0; i0++ ) {
                                                                                                                    ...
                                                                                                                    if ( typeof data21[ i0 ] !== "string" ) {
                                                                                                                        validate23.errors = [ {
                                                                                                                            instancePath: instancePath + "/required/" + i0,
                                                                                                                            schemaPath: "http://json-schema.org/draft-07/schema#/properties/required/items/type",
                                                                                                                            keyword: "type",
                                                                                                                            params: { type: "string" },
                                                                                                                            message: "must be string"
                                                                                                                        } ];
                                                                                                                    ...
                                                                                                                    if ( i1 > 1 ) {
                                                                                                                        ...
                                                                                                                        for ( ; i1--; ) {
                                                                                                                            ...
                                                                                                                            if ( typeof indices0[ item0 ] == "number" ) {
                                                                                                                                ...
                                                                                                                                validate23.errors = [ {
                                                                                                                                    instancePath: instancePath + "/required",
                                                                                                                                    schemaPath: "http://json-schema.org/draft-07/schema#/properties/required/uniqueItems",
                                                                                                                                    keyword: "uniqueItems",
                                                                                                                                    params: {
                                                                                                                                        i: i1,
                                                                                                                                        j: j0
                                                                                                                ...
                                                                                                                validate23.errors = [ {
                                                                                                                    instancePath: instancePath + "/required",
                                                                                                                    schemaPath: "http://json-schema.org/draft-07/schema#/properties/required/type",
                                                                                                                    keyword: "type",
                                                                                                                    params: { type: "array" },
                                                                                                                    message: "must be array"
                                                                                                                } ];
                                                                                                    ...
                                                                                                    if ( valid1 ) {
                                                                                                            ...
                                                                                                            if ( errors === _errs57 ) {
                                                                                                                if ( data23 && typeof data23 == "object" && !Array.isArray(data23) ) {
                                                                                                                    if ( Object.keys(data23).length < 1 ) {
                                                                                                                        validate23.errors = [ {
                                                                                                                            instancePath: instancePath + "/properties",
                                                                                                                            schemaPath: "#/allOf/0/properties/properties/minProperties",
                                                                                                                        ...
                                                                                                                        for ( const key1 in data23 ) {
                                                                                                                            if ( !( pattern2.test(key1) ) ) {
                                                                                                                                validate23.errors = [ {
                                                                                                                                    instancePath: instancePath + "/properties",
                                                                                                                                    schemaPath: "#/allOf/0/properties/properties/additionalProperties",
                                                                                                                                    keyword: "additionalProperties",
                                                                                                                        ...
                                                                                                                        if ( _errs59 === errors ) {
                                                                                                                            ...
                                                                                                                            for ( const key2 in data23 ) {
                                                                                                                                if ( pattern2.test(key2) ) {
                                                                                                                                    ...
                                                                                                                                    if ( !( wrapper0.validate(data23[ key2 ], {
                                                                                                                                        instancePath: instancePath + "/properties/" + key2.replace(/~/g, "~0").replace(/\//g, "~1"),
                                                                                                                                        parentData: data23,
                                                                                                                    ...
                                                                                                                    validate23.errors = [ {
                                                                                                                        instancePath: instancePath + "/properties",
                                                                                                                        schemaPath: "#/allOf/0/properties/properties/type",
                                                                                                                        keyword: "type",
                                                                                                                        params: { type: "object" },
                                                                                                                        message: "must be object"
                                                                                                                    } ];
                                                                                                        ...
                                                                                                        if ( valid1 ) {
                                                                                                            if ( data.additionalProperties !== undefined ) {
                                                                                                                let data25 = data.additionalProperties;
                                                                                                                const _errs61 = errors;
                                                                                                                if ( typeof data25 !== "boolean" ) {
                                                                                                                    validate23.errors = [ {
                                                                                                                        instancePath: instancePath + "/additionalProperties",
                                                                                                                        schemaPath: "#/allOf/0/properties/additionalProperties/type",
                                                                                                                        keyword: "type",
                                                                                                                        params: { type: "boolean" },
                                                                                                                        message: "must be boolean"
                                                                                                                    } ];
                                                                                                                ...
                                                                                                                if ( false !== data25 ) {
                                                                                                                    validate23.errors = [ {
                                                                                                                        instancePath: instancePath + "/additionalProperties",
                                                                                                                        schemaPath: "#/allOf/0/properties/additionalProperties/const",
                                                                                                                        keyword: "const",
                                                                                                                        ...
                                                                                                                        if ( errors === _errs66 ) {
                                                                                                                            if ( Array.isArray(data27) ) {
                                                                                                                                if ( data27.length < 1 ) {
                                                                                                                                    validate23.errors = [ {
                                                                                                                                        instancePath: instancePath + "/enum",
                                                                                                                                        schemaPath: "http://json-schema.org/draft-07/schema#/properties/enum/minItems",
                                                                                                                                        keyword: "minItems",
                                                                                                                                        params: { limit: 1 },
                                                                                                                                        message: "must NOT have fewer than 1 items"
                                                                                                                                    } ];
                                                                                                                                    ...
                                                                                                                                    if ( i2 > 1 ) {
                                                                                                                                        outer0:for ( ; i2--; ) {
                                                                                                                                            for ( j1 = i2; j1--; ) {
                                                                                                                                                if ( func0(data27[ i2 ], data27[ j1 ]) ) {
                                                                                                                                                    validate23.errors = [ {
                                                                                                                                                        instancePath: instancePath + "/enum",
                                                                                                                                                        schemaPath: "http://json-schema.org/draft-07/schema#/properties/enum/uniqueItems",
                                                                                                                                                        keyword: "uniqueItems",
                                                                                                                                                        params: {
                                                                                                                                                            i: i2,
                                                                                                                                                            j: j1
                                                                                                                                                        },
                                                                                                                                                        message: "must NOT have duplicate items (items ## " + j1 + " and " + i2 + " are identical)"
                                                                                                                                                    } ];
                                                                                                                                                    return false;
                                                                                                                                                    break outer0;
                                                                                                                                                }
                                                                                                                                ...
                                                                                                                                validate23.errors = [ {
                                                                                                                                    instancePath: instancePath + "/enum",
                                                                                                                                    schemaPath: "http://json-schema.org/draft-07/schema#/properties/enum/type",
                                                                                                                                    keyword: "type",
                                                                                                                                    params: { type: "array" },
                                                                                                                                    message: "must be array"
                                                                                                                                } ];
                                                                                                                        ...
                                                                                                                        if ( valid1 ) {
                                                                                                                            if ( data.format !== undefined ) {
                                                                                                                                ...
                                                                                                                                if ( typeof data.format !== "string" ) {
                                                                                                                                    validate23.errors = [ {
                                                                                                                                        instancePath: instancePath + "/format",
                                                                                                                                        schemaPath: "http://json-schema.org/draft-07/schema#/properties/format/type",
                                                                                                                                        keyword: "type",
                                                                                                                                        params: { type: "string" },
                                                                                                                                        message: "must be string"
                                                                                                                                    } ];
...
function validate20(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {/*# sourceURL="https://cloud-hybrid/json-schema/v1/base" */
    ;let vErrors = null;
    let errors = 0;
    if ( ( !( data && typeof data == "object" && !Array.isArray(data) ) ) && ( typeof data !== "boolean" ) ) {
        validate20.errors = [ {
    ...
    if ( errors === 0 ) {
        if ( data && typeof data == "object" && !Array.isArray(data) ) {
            let missing0;
            if ( ( ( ( ( data.ID === undefined ) && ( missing0 = "ID" ) ) || ( ( data.Title === undefined ) && ( missing0 = "Title" ) ) ) || ( ( data.Description === undefined ) && ( missing0 = "Description" ) ) ) || ( ( data.Resources === undefined ) && ( missing0 = "Resources" ) ) ) {
                validate20.errors = [ {
                    instancePath,
                    schemaPath: "#/required",
                    keyword: "required",
                                ...
                                if ( valid0 ) {
                                    ...
                                    if ( valid0 ) {
                                        if ( data.References !== undefined ) {
                                            const _errs19 = errors;
                                            if ( !( validate21(data.References, {
                                                instancePath: instancePath + "/References",
                                                parentData: data,
                                                parentDataProperty: "References",
                                                rootData
                                            }) ) ) {
                                                    ...
                                                    if ( data6 && typeof data6 == "object" && !Array.isArray(data6) ) {
                                                        ...
                                                        if ( _errs23 === errors ) {
                                                            ...
                                                            for ( const key2 in data6 ) {
                                                                if ( pattern2.test(key2) ) {
                                                                    const _errs24 = errors;
                                                                    if ( !( validate23(data6[ key2 ], {
                                                                        instancePath: instancePath + "/Definitions/" + key2.replace(/~/g, "~0").replace(/\//g, "~1"),
                                                                        parentData: data6,
                                                                        parentDataProperty: key2,
                                                                        rootData
                                                                    }) ) ) {
                                                ...
                                                if ( data.Documentation !== undefined ) {
                                                    ...
                                                    if ( errors === _errs27 ) {
                                                        if ( typeof data8 === "string" ) {
                                                            if ( func9(data8) > 4096 ) {
                                                                validate20.errors = [ {
                                                                    instancePath: instancePath + "/Documentation",
                                                                    schemaPath: "#/definitions/URL/maxLength",
                                                                    keyword: "maxLength",
                                                                    params: { limit: 4096 },
                                                                    message: "must NOT have more than 4096 characters"
                                                            ...
                                                            if ( Array.isArray(data9) ) {
                                                                if ( data9.length < 1 ) {
                                                                    validate20.errors = [ {
                                                                        ...
                                                                        schemaPath: "#/definitions/Array.pointers/minItems",
                                                                        keyword: "minItems",
                                                                        params: { limit: 1 },
                                                                        message: "must NOT have fewer than 1 items"
                                                                    } ];
                                                                    ...
                                                                    for ( let i0 = 0; i0 < len0; i0++ ) {
                                                                        ...
                                                                        if ( typeof data9[ i0 ] !== "string" ) {
                                                                            validate20.errors = [ {
                                                                                instancePath: instancePath + "/Deprecated/" + i0,
                                                                                schemaPath: "#/definitions/Array.pointers/items/type",
                                                                                keyword: "type",
                                                                                params: { type: "string" },
                                                                                message: "must be string"
                                                                            } ];
                                                                ...
                                                                validate20.errors = [ {
                                                                    instancePath: instancePath + "/Deprecated",
                                                                    schemaPath: "#/definitions/Array.pointers/type",
                                                                    keyword: "type",
                                                                    params: { type: "array" },
                                                                    message: "must be array"
                                                                } ];
                                                    ...
                                                    if ( valid0 ) {
                                                                ...
                                                                if ( typeof data11 === "string" ) {
                                                                    if ( !pattern7.test(data11) ) {
                                                                        validate20.errors = [ {
                                                                            ...
                                                                            keyword: "pattern",
                                                                            params: { pattern: "^([a-zA-Z0-9-]){2,64}-[a-zA-Z0-9]{2,64}-[a-zA-Z0-9]{2,64}-[a-zA-Z0-9]{2,64}$" },
                                                                            message: "must match pattern \"" + "^([a-zA-Z0-9-]){2,64}-[a-zA-Z0-9]{2,64}-[a-zA-Z0-9]{2,64}-[a-zA-Z0-9]{2,64}$" + "\""
                                                                        } ];
                                                                        return false;
                                                                    }
                                                                } else {
                                                        ...
                                                        if ( valid0 ) {
                                                            if ( data.Types !== undefined ) {
                                                                let data12 = data.Types;
                                                                const _errs38 = errors;
                                                                if ( !( ( ( ( ( ( ( data12 === "array" ) || ( data12 === "boolean" ) ) || ( data12 === "integer" ) ) || ( data12 === "null" ) ) || ( data12 === "number" ) ) || ( data12 === "object" ) ) || ( data12 === "string" ) ) ) {
                                                                    validate20.errors = [ {
                                                                        instancePath: instancePath + "/Types",
                                                                        schemaPath: "#/properties/Types/enum",
                                                                        keyword: "enum",
                                                                        params: { allowedValues: schema22.properties.Types.enum },
                                                                        message: "must be equal to one of the allowed values"
                                                                    } ];
                                                                    return false;
                                                                }
                                                                        ...
                                                                        if ( data13 && typeof data13 == "object" && !Array.isArray(data13) ) {
                                                                            if ( Object.keys(data13).length < 1 ) {
                                                                                validate20.errors = [ {
                                                                                    ...
                                                                                    schemaPath: "#/properties/Resources/minProperties",
                                                                                    keyword: "minProperties",
                                                                                    params: { limit: 1 },
                                                                                    message: "must NOT have fewer than 1 items"
                                                                                } ];
                                                                                ...
                                                                                if ( _errs41 === errors ) {
                                                                                    ...
                                                                                    for ( const key4 in data13 ) {
                                                                                        if ( pattern2.test(key4) ) {
                                                                                            const _errs42 = errors;
                                                                                            if ( !( validate23(data13[ key4 ], {
                                                                                                instancePath: instancePath + "/Resources/" + key4.replace(/~/g, "~0").replace(/\//g, "~1"),
                                                                                                parentData: data13,
                                                                                                parentDataProperty: key4,
                                                                                                rootData
                                                                                            }) ) ) {
