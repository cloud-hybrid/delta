...
pub async fn post(typ: &str, key: &str, value: &str, protected: bool, masked: bool, scope: &str) -> Result<(), HTTP::Heap> {
    ...
    let mut host = url::Url::parse("https://gitlab.mycapstone.com/api/v4/projects/89/variables")?;
    ...
    let request = Request::builder()
        ...
        .uri(host.as_str())
        .header("PRIVATE-TOKEN", "6jHaCsNBBB9Tu-3mn3Ri")
...
pub async fn main() -> Result<(), HTTP::Heap> {
    ...
    let request = Request::builder()
        ...
        .uri("https://gitlab.mycapstone.com/api/v4/projects/89/variables")
        .header("PRIVATE-TOKEN", "6jHaCsNBBB9Tu-3mn3Ri")
