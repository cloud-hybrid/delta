...
"""
Auto-Generated Python Module - November
...
class Day(Scheme):
    ...
    class Config(Base.Config, Setup): title = Base.Config.title + "-" + "November" + "-" + "Day"

class Days(Scheme):
    """
    A Schema Representation of the Days in November, 2021
    """
    ...
    First: Day = Field(
        default = Day(
            Canonical = "Monday",
            Week = 44,
            Month = ("November", "Nov", 11),
            ISO = ("2021", 44, 1),
            Value = 1
        ), description = "Day Schema Representation for Date in November, 2021"
    )
    ...
    class Config(Base.Config, Setup): title = Base.Config.title + "-" + "November" + "-" + "Days"

class Month(Scheme):
    """
    A Schema Representation of November in the Year 2021
    """

    Year: Integer = Field(default_factory = lambda: datetime.date.today().year)
    Canonical: String = Field(default = "November", description = "Canonical Name for November")
    Triple: Tuple[String, Integer, Integer] = Field(default = (November, 11, 30))

    Dates: Days = Days()

    class Config(Base.Config, Setup): title = Base.Config.title + "-" + "November"
