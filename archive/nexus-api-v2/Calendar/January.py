...
"""
Auto-Generated Python Module - January
...
class Day(Scheme):
    ...
    class Config(Base.Config, Setup): title = Base.Config.title + "-" + "January" + "-" + "Day"

class Days(Scheme):
    """
    A Schema Representation of the Days in January, 2021
    """
    ...
    First: Day = Field(
        default = Day(
            ...
            ISO = ("2020", 53, 5),
            Value = 1
        ), description = "Day Schema Representation for Date in January, 2021"
    )
    ...
    class Config(Base.Config, Setup): title = Base.Config.title + "-" + "January" + "-" + "Days"

class Month(Scheme):
    """
    A Schema Representation of January in the Year 2021
    """

    Year: Integer = Field(default_factory = lambda: datetime.date.today().year)
    Canonical: String = Field(default = "January", description = "Canonical Name for January")
    Triple: Tuple[String, Integer, Integer] = Field(default = (January, 1, 31))

    Dates: Days = Days()

    class Config(Base.Config, Setup): title = Base.Config.title + "-" + "January"
