...
const Cryptography = window.crypto;
...
export const Preview = "PREVIEW-ID";
...
const Component = ({ state }) => {
    ...
    // useEffect(() => {
    //     require("axios").get("https://localhost:3000" + "/Mongo/URLs/Interfaces", {
    //         headers: {
    ...
    const UID = () => Cryptography.getRandomValues(256 / 8).toString("hex");
