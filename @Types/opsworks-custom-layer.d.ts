...
export declare function opsworksCustomLayerEbsVolumeToTerraform(struct?: OpsworksCustomLayerEbsVolume): any;
/**
...
export declare class OpsworksCustomLayer extends cdktf.TerraformResource {
    ...
    */
    ...
    private _ebsVolume?;
    get ebsVolume(): OpsworksCustomLayerEbsVolume[];
    set ebsVolume(value: OpsworksCustomLayerEbsVolume[]);
    resetEbsVolume(): void;
    get ebsVolumeInput(): OpsworksCustomLayerEbsVolume[];
    protected synthesizeAttributes(): {
        [name: string]: any;
    };
}
//# sourceMappingURL=opsworks-custom-layer.d.ts.map